...
<body class="bg-[#1B75BB] flex items-center justify-center min-h-screen">
    ...
    <div class="text-center text-[#499cbf] mb-8">
        ...
        <button class="mt-5 px-10 my-2 py-2 bg-[#499cbf] text-white rounded font-bold"><a href="/login">LOGIN</a></button>
        <p class="text-[#499cbf] mb-4 mt-3">atau <span class="font-bold"><a href="/login">MASUK</a></span> sebagai dosen</p>
    </div>
    </div>
</body>
</html>
